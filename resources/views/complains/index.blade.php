                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            @can('complain-create')
                                <a class="btn btn-primary" href="{{ route('complains.create') }}">Write a Complain</a>
                            @endcan
                        </div>
                        <!-- /.card-header -->
                                                        ...
                                                        @if ($auth_role == 'Superadmin')
                                                            ...
                                                            @else
                                                                @if ($complain->status == 'pending')
                                                                    @can('complain-delete')
                                                                        <a data-id="{{ $complain->id }}"
                                                                            class="btn btn-primary complain_id" data-toggle="modal"
                                                                ...
                                                                @if ($complain->status == 'in_progress')
                                                                    @can('complain-delete')
                                                                        <a data-id="{{ $complain->id }}"
                                                                            class="btn btn-success resolve_id" data-toggle="modal"
                                                                            data-target=".bd-example-modal-resolved"><i
                                                                                class="fa fa-check"></i>&nbsp;Resolved</a>
                                                                    @endcan
                                                                @else
                                                                @endif
                                                            @endif
