                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-1">
                                        ...
                                        <input type="text" name="title" value="{{ old('title', $tenant->title) }}"
                                            class="form-control" required>
                                    </div>
                                    <div class="col-3">
                                        <label for="exampleInputEmail1">First Name</label>
                                        <input type="text" name="firstname"
                                            value="{{ old('firstname', $tenant->firstname) }}" class="form-control"
                                            placeholder="Please Enter First Name">
                                    </div>
                                    <div class="col-4">
                                        <label for="exampleInputEmail1">Last Name</label>
                                        <input type="text" name="lastname"
                                            value="{{ old('lastname', $tenant->lastname) }}" class="form-control"
                                            placeholder="Please Enter Last Name">
                                    </div>
                                    <div class="col-4">
                                        <label for="exampleInputEmail1">Middle Name</label>
                                        <input type="text" name="middlename"
                                            value="{{ old('middlename', $tenant->middlename) }}" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <input type="email" name="primary_email"
                                            value="{{ old('primary_email', $tenant->primary_email) }}" class="form-control"
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="email" name="secondary_email"
                                            value="{{ old('secondary_email', $tenant->secondary_email) }}"
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="email" name="alternate_email"
                                            value="{{ old('alternate_email', $tenant->alternate_email) }}"
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        ...
                                        <input type="text" name="landline"
                                            value="{{ old('landline', $tenant->landline) }}" class="form-control"
                                            placeholder="Please Enter Landline">
                                    </div>
                                    <div class="col-4">
                                        <label for="exampleInputEmail1">Primary Mobile</label>
                                        <input type="text" name="primary_mobile"
                                            value="{{ old('primary_mobile', $tenant->primary_mobile) }}"
                                            class="form-control" placeholder="Please Enter Primary Mobile">
                                    </div>
                                    <div class="col-4">
                                        <label for="exampleInputEmail1">Secondary Mobile</label>
                                        <input type="text" name="secondary_mobile"
                                            value="{{ old('secondary_mobile', $tenant->secondary_mobile) }}"
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ $tenant->valid_id }}</label>
                                                </div>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" name="other_document" class="custom-file-input"
                                                        id="exampleInputFile">
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ $tenant->other_document }}</label>
                                                </div>
                                                <div class="input-group-append">
                                                    <span class="input-group-text">Upload</span>
                                                </div>
