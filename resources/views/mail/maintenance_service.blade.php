...
<body
    ...
    <span class="preheader"
        style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Maintenance
        Service Notice </span>
            ...
            <td class="container"
                ...
                <div class="content"
                    ...
                    <table role="presentation" class="main"
                        ...
                        width="100%">
                        @php
                            $PurposeOfMaintenance = 'HI ia m fune';
                        @endphp
        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <td class="content-block"
                    ...
                    <span class="apple-link" style="color: #999999; font-size: 12px; text-align: center;">Company Inc, 3
